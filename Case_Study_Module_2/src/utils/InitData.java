...
public class InitData {
    ...
    public static void initRoom() {
        ...
        Room room12 = new Room(43, "T4-3", ERoomStatus.available, ERoomType.VIP, 50, 100000);

        List<Room> rooms = new ArrayList<>(Arrays.asList(room1, room2, room3, room4, room5, room6,room7,room8,room9,room10,room11,room12));
        RoomService.roomList =rooms;
...
//
        ...
        Reservation reservation1 = new Reservation("S123","Duy",date1,
